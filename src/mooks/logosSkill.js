...
import framerMotionLogo from "../assets/img/logo-skills/framer-motion.png";
...
import sequelize from "../assets/img/logo-skills/sequelize.svg";
//tools
...
export const arrayLogos = [
  { id: 1,name: "CSS", logo: cssLogo },
  { id: 2,name: "HTML", logo: htmlLogo },
  { id: 3,name: "Javascript", logo: javascriptLogo },
  { id: 4,name: "React", logo: reactLogo },
  { id: 5,name: "Next.js", logo: nextLogo },
  { id: 6,name: "Redux", logo: reduxLogo },
  { id: 7,name: "Sass", logo: sassLogo },
  { id: 8,name: "Tailwind", logo: tailwindLogo },
  { id: 9,name: "Typescript", logo: typescriptLogo },
  { id: 10,name: "Express", logo: expressLogo },
  { id: 11,name: "Firebase", logo: firebaseLogo },
  { id: 12,name: "MongoDB", logo: mongodbLogo },
  { id: 13,name: "Node.js", logo: nodeLogo },
  { id: 14,name: "Postgres", logo: postgresLogo },
  { id: 15,name: "Nest", logo: nestLogo },
  { id: 16,name: "OpenAI", logo: openaiLogo },
  { id: 17,name: "JWT", logo: jwtLogo },
  { id: 18,name: "Git", logo: gitLogo },
  { id: 19,name: "Github", logo: githubLogo },
  { id: 20,name: "Docker", logo: dockerLogo },
